...
import org.mastodon.graph.ref.GraphWithFeaturesImp;
 ...
 */
public class BranchGraphWithFeatures< V extends Vertex< E >, E extends Edge< V > >
		extends GraphWithFeaturesImp< 
			BranchVertexWithFeaturesPool, 
			BranchEdgeWithFeaturesPool, 
			BranchVertexWithFeatures, 
			BranchEdgeWithFeatures, 
			ByteMappedElement >
{

	private final BranchGraphListener< V, E, BranchVertexWithFeatures, BranchEdgeWithFeatures > branchGraphListener;
	 ...
	 */
	public BranchGraphWithFeatures( final ListenableGraph< V, E > graph )
	{
		super( new BranchEdgeWithFeaturesPool( 1000, new BranchVertexWithFeaturesPool( 1000 ) ) );
	 ...
	 */
	public BranchVertexWithFeatures getBranchVertex( final V vertex, final BranchVertexWithFeatures ref )
	{
	 ...
	 */
	public BranchEdgeWithFeatures getBranchEdge( final V vertex, final BranchEdgeWithFeatures ref )
	{
	 ...
	 */
	public BranchEdgeWithFeatures getBranchEdge( final E edge, final BranchEdgeWithFeatures ref )
	{
	 ...
	 */
	public V getLinkedVertex( final BranchVertexWithFeatures bv, final V ref )
	{
	 ...
	 */
	public E getLinkedEdge( final BranchEdgeWithFeatures be, final E ref )
	{
	...
	public String toString()
	{
		...
		for ( final BranchVertexWithFeatures bv : vertices() )
			sb.append( "    " + ( bv ) + "\n" );
		sb.append( "  },\n" );
		sb.append( "  edges = {\n" );
