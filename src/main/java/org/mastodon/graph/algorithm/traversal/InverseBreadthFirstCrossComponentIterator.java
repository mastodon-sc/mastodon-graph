...
/**
 * Same as {@link BreadthFirstCrossComponentIterator} on a graph where all
...
public class InverseBreadthFirstCrossComponentIterator< V extends Vertex< E >, E extends Edge< V > > extends BreadthFirstCrossComponentIterator< V, E >
{
	...
	/**
	 * Creates a breadth-first, cross-component inverse iterator starting from
	 ...
	 */
	public InverseBreadthFirstCrossComponentIterator( final V start, final ReadOnlyGraph< V, E > graph )
	{
	...
	/**
	 * Creates a breadth-first, cross-component inverse iterator starting from
	 * the specified vertex, using the specified collection of leaves to jump
	 ...
	 */
	public InverseBreadthFirstCrossComponentIterator( final V start, final ReadOnlyGraph< V, E > graph, final Iterable< V > leaves )
	{
