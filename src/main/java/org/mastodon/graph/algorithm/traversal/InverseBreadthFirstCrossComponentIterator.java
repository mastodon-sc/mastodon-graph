...
public class InverseBreadthFirstCrossComponentIterator< V extends Vertex< E >, E extends Edge< V > > extends BreadthFirstCrossComponentIterator< V, E >
{
	 ...
	 */
	public InverseBreadthFirstCrossComponentIterator( final V start, final Graph< V, E > graph )
	{
	 ...
	 */
	public InverseBreadthFirstCrossComponentIterator( final V start, final Graph< V, E > graph, final Iterable< V > leaves )
	{
